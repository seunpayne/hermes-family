...
<!-- Agent-populated reference documents -->
- `references/clerk-jwks-auth.md` — Clerk RS256 JWKS JWT verification in NestJS backends
- `references/clerk-nextjs-frontend.md` — Clerk v6 frontend integration in Next.js App Router
- `references/multi-tenant-jwt-scoping.md` — Multi-tenant architecture using community_id in JWT claims
- `references/nestjs-guard-pitfalls.md` — NestJS guard pitfalls: @Public() class-level override, RolesGuard/JwtAuthGuard ordering
- `references/nestjs-module-circular-deps.md` — NestJS circular deps resolution, Prisma relation access, and feature audit checklist
- `references/nestjs-notification-processor-pitfalls.md` — Silent notification failures from dynamic require() on uncompiled dist/ files
- `references/prisma-indirect-relation-joins.md` — Prisma `communityId` trap: always include compound join for indirect relations; audit checklist
- `references/notification-channel-audit.md` — Audit methodology for Clerk-based vs phone-based recipients; channel map guidelines post ADD-034